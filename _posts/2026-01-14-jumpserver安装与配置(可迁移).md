---
share: true
title: jumpserver安装与配置(可迁移)
date created: 2026-01-14
date modified: 2026-01-14
sharetitle: 2026-01-14-jumpserver安装与配置(可迁移)
tags:
  - 运维
---
官方安装脚本
...
#
SECRET_KEY=YGEjDlK1wC8t03lWQQE9mdViH3GWIpmJa2WvefJ3SYsxltUn
...
#
BOOTSTRAP_TOKEN=Cnvod3ju3AgtqWTDNRJ5vaUP
...
DB_PORT=5432
DB_USER=postgres
DB_PASSWORD=PBLw4hE80SsBL1K13WRjSLTqfU
DB_NAME=jumpserver
...
REDIS_HOST=redis
REDIS_PORT=6379
REDIS_PASSWORD=XrsKJpwm2az0eXWSIwyHlzDoHI
...
CURRENT_VERSION=v4.3.1-ce
```

挂载data到nas

```
192.168.0.10:/volume1/appdata/jump  /mnt/appdata/jump  nfs4  defaults  0  0
```
